...
const loader1 = (source) => {
    return `${source}//给你的代码加点注:loader1`
};

const loader2 = (source) => {
    return `${source}//给你的代码加点注:loader2`
};
...
class Compilation {
    ...
    build(callback) {
        ...
        console.log('🚀 ~ Compilation ~ build ~ this.modules:', this.modules)
        console.log('🚀 ~ Compilation ~ build ~ this.chunks:', this.chunks)
        console.log('🚀 ~ Compilation ~ build ~ this.assets:', this.assets)
        console.log('🚀 ~ Compilation ~ build ~ this.fileDependencies:', this.fileDependencies)
